...
contract ManagedPoolController is BasePoolController {
    ...
    struct ManagedPoolRights {
        bool canChangeWeights; // sim
        bool canDisableSwaps; // sim
        bool canSetMustAllowlistLPs; // sim / com nossa logica
        bool canSetCircuitBreakers; // ?? não esta implementada ainda
        bool canChangeTokens; // sim -> seguindo whitelist
        bool canChangeMgmtFees; // não
        bool canDisableJoinExit; // ?? verificar como funciona
        
        // verificar se vamos ter permissões para trocar o manager fee e referral fee e se vamos ter limits
    }
